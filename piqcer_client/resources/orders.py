...
class Orders(Resource):
    ...
    def process_order(self, id):
        return requests.get(self.config.base_url + self.path + "/" + str(id) + '/process', verify=True,
    ...
    def post_notes(self, id, notes_object):
        return requests.post(self.config.base_url + self.path + "/" + str(id) + "/notes", data=notes_object, verify=True,
                      auth=HTTPBasicAuth(self.config.api_key, '')).json()
    ...
    def update_product(self, id, idorder_product, product_object):
        return requests.put(self.config.base_url + self.path + "/" + str(id) + "/products/" + str(idorder_product), data=product_object,
                             verify=True,
                             auth=HTTPBasicAuth(self.config.api_key, '')).json()
